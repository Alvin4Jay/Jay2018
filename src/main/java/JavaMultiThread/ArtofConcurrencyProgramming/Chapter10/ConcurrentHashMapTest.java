...
public class ConcurrentHashMapTest {
	...
	private static ThreadPoolExecutor executor = new ThreadPoolExecutor(2, 2, Long.MAX_VALUE, TimeUnit.MILLISECONDS,
			new LinkedBlockingQueue<>(), new ThreadFactory() {
		private AtomicLong counter = new AtomicLong(0);

		@Override
		public Thread newThread(Runnable r) {
			Thread thread = new Thread(r, "thread-" + counter.incrementAndGet());
			return thread;
		}
	});
